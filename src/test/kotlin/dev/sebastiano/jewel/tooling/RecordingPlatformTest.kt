...
class RecordingPlatformTest : BasePlatformTestCase() {
  fun testPlatformJacksonApiIsAvailable() {
    val descriptor =
      checkNotNull(PluginManagerCore.getPlugin(PluginId.getId("dev.sebastiano.jewel.tooling")))
    ...
    builder.javaClass.getMethod("maxNestingDepth", Int::class.javaPrimitiveType).invoke(builder, 8)

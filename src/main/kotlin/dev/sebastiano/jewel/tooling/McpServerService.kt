...
internal class McpServerController(
    ...
    // Startup crosses a private classloader. Preserve IDE cancellation before showing a local
    // error.
        ...
        try {
            ...
            val callback =
                BiFunction<String, String, CompletableFuture<String>> { tool, request ->
                    scope.future(analysisDispatcher) {
                        requests.call(tool, request, discovery, root, facade)
                    }
                }

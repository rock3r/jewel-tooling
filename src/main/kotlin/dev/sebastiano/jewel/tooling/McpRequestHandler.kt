...
internal class McpRequestHandler(
  ...
  // Convert unexpected request failures at the protocol boundary, without swallowing control flow.
  ...
  private fun status(message: JsonObject, discovery: Discovery, root: Path) =
    McpResults.success(
      mapOf(
        ...
        "tools" to listOf("jewel_status", "jewel_composables", "jewel_analyze", "jewel_explain"),

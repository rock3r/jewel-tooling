...
internal object CompilerStabilityMetadata {
  ...
  fun decode(bytes: ByteArray, internalName: String, typeParameters: Int): Result {
    if (bytes.size > MAX_BYTES || typeParameters !in 0..MAX_PARAMETERS) return Result.Unsupported
    return try {
  ...
  private class MetadataVisitor(private val expectedName: String, private val expectedCount: Int) :
    ...
    override fun visitInnerClass(
      ...
      if (name == expectedName)
        requireShape(outerName != null && innerName != null && access and Opcodes.ACC_STATIC != 0)
    }
      ...
      when (descriptor) {
        ...
        "Landroidx/compose/runtime/internal/StabilityInferred;" -> {
          ...
          object : AnnotationVisitor(Opcodes.ASM9) {
            ...
            override fun visitArray(name: String?): AnnotationVisitor = throw UnsupportedShape()
    ...
    override fun visitField(
      ...
      requireShape(
        access and (Opcodes.ACC_PRIVATE or Opcodes.ACC_PROTECTED or Opcodes.ACC_VOLATILE) == 0
      )
    ...
    override fun visitMethod(
      ...
      requireShape(initializer == null && descriptor == "()V" && access and Opcodes.ACC_STATIC != 0)

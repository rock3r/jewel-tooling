  ...
  fun bundledRuntimeUsesOwnKotlinAndOnlyJdkBoundaryTypes() {
    ...
    URLClassLoader(
      ...
      .use { loader ->
        ...
        assertSame(
          loader,
          loader.loadClass("io.modelcontextprotocol.kotlin.sdk.server.Server").classLoader,
        )
        val type = loader.loadClass("dev.sebastiano.jewel.tooling.mcp.runtime.RuntimeServer")
        val start =
          type.getMethod("start", Map::class.java, String::class.java, BiFunction::class.java)
        val callback =

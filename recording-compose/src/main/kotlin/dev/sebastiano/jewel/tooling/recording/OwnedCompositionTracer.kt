...
class OwnedCompositionTracer internal constructor() : CompositionTracer, AutoCloseable {
  ...
  companion object {
    ...
    /**
     * Installs the dispatcher once in an explicitly controlled development host. This method cannot
     * detect or restore another tracer. Do not call it from a normal authoring IDE plugin.
     */
